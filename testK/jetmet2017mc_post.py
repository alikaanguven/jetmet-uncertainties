...
https://github.com/cms-nanoAOD/nanoAOD-tools/blob/master/scripts/nano_postproc.py
https://github.com/cms-nanoAOD/nanoAOD-tools/blob/master/python/postprocessing/examples/example_postproc.py
...
if __name__ == "__main__":
    ...
    jmeCorrections = createJMECorrector(True, "UL2017", "None", "Total", "AK4PFchs")
